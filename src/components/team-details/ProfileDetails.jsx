              ...
              <div className="row ltn__custom-gutter mt-50 mb-20">
                ...
                <div className="col-xl-4 col-sm-6 col-12">
                  <div className="ltn__feature-item ltn__feature-item-6 active">
                    ...
                    <div className="ltn__feature-info">
                      <h3>
                        <a href="team.html">Expert Mechanics</a>
                      </h3>
                      <p>
                        Lorem ipsum dolor sit ame it, consectetur adipisicing
                        elit, sed do eiusmod te mp or incididunt ut labore.
                      </p>
                      <a className="ltn__service-btn" href="team.html">
                        Read More
                      </a>
                    </div>
                  </div>
                ...
                <div className="col-xl-4 col-sm-6 col-12">
                  <div className="ltn__feature-item ltn__feature-item-6">
                    <div className="ltn__feature-icon">
                      <span>
                        <i className="icon-wheel-1"></i>
                      </span>
                    </div>
                    <div className="ltn__feature-info">
                      <h3>
                        <a href="service-details.html">Repair Vehicales</a>
                      </h3>
                      <p>
                        Lorem ipsum dolor sit ame it, consectetur adipisicing
                        elit, sed do eiusmod te mp or incididunt ut labore.
